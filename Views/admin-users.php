...
<html lang="nl">
	...
	<body class="container-fluid">
		 ...
		 <?php if (isset($_GET['editUser'])) {
			...
			echo "<div class='pop-up-edit-lineitem clearfix'><div class='popup-label'>Naam:</div><input class='input-popup' type='text' name='naam' value='".$requestedEditUser->naam."'></div>";
			echo "<div class='pop-up-edit-lineitem clearfix'><div class='popup-label'>Voornaam:</div><input class='input-popup' type='text' name='voornaam' value='".$requestedEditUser->voornaam."'></div>";
			echo "<div class='pop-up-edit-lineitem clearfix'><div class='popup-label'>E-mail adres:</div><input class='input-popup' type='text' name='emailadres' value='".$requestedEditUser->emailadres."'></div>";
